...
const COCKTAILS = [
  ...
  },
  {
    ...
    base: 'Ванильная водка', abv: '17%', vol: '120 мл + 50 мл', serve: 'Купе, шот просекко рядом',
    recipe: ['Ванильная водка — 45 мл', 'Ликёр маракуйи Passoa — 15 мл', 'Сок маракуйи — 30 мл',
             'Ванильный сироп — 15 мл', 'Сок лайма — 15 мл', 'Просекко брют — 50 мл отдельно'],
